...
EFFECTS:{"treasury_delta":0,"income_delta":0,"army_delta":0,"stability_delta":0,"relations":{"Испания":0,"Великобритания":0,"Россия":0,"Австрия":0,"Пруссия":0},"war_declared":[],"peace_made":[],"ruler_name":null,"government":null,"pm_name":null}
...
- Беспорядки, восстания, разгром промышленности → income_delta отрицательный (постоянное снижение месячного дохода), stability_delta отрицательный
- Реформы, новые фабрики, выгодная торговля → income_delta положительный
